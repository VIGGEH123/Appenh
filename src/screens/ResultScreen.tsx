...
import { Sparkles, TrendingUp, Heart, ArrowRight, Check, Wallet } from 'lucide-react';
...
export function ResultScreen({ savedAmount, totalSaved, ordersCount, onGoHome }: ResultScreenProps) {
  const [selectedDonation, setSelectedDonation] = useState<number | null>(10);
        ...
        {!donated ? (
          <div className="bg-white/5 backdrop-blur-md rounded-3xl p-5 border border-white/10 mb-6">
            ...
            <p className="text-stone-400 text-sm leading-relaxed mb-4">
              Du sparade {formatSEK(savedAmount)} idag. Om du vill kan du ge en liten slant till
              utvecklarna som byggde appen — som ett tack för alla pengar du sparade.
            </p>
            ...
            >
              Donera {selectedDonation} kr <ArrowRight className="w-4 h-4" />
            </button>
            <button
              onClick={onGoHome}
